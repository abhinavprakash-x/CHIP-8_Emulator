...
; Standard Chip-8 has no "+" font. We must build it manually.
; We will store this custom sprite at memory address 0x300.
; ==================================================================
...
; Now we have a "+" sprite waiting for us!
...
; We ignore the value of 'A' and just draw the + sign
...
; ==================================================================
; STEP 5: HANDLE DOUBLE DIGIT OUTPUT (THE BCD TRICK)
; If result is 18, we can't just "Draw 18". We need to split it into '1' and '8'.
; Chip-8 has a magic opcode (Fx33) for this!
; ==================================================================
