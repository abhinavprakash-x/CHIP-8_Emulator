; ==================================================================
; SECTION 1: SPRITE LOADER
; We manually load the hex data for H, E, L, L, O into memory 
; starting at address 0x300.
; ==================================================================
...
; ==================================================================
; SECTION 2: INITIALIZATION (0x200 + Loader Size = 0x246)
; ==================================================================
